<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PropertyType.aspx.cs" Inherits="Default2" %>
        ...
        <div class="modal-dialog modal-md " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="lbltitle">Add/ Edit Property Type</h2>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <input id="TxtPropertyType" autocomplete="off" onkeyup="isalpha(this);" class="form-control clrtxt" type="text" />
                        </div>
                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="Server">
    <script src="js/PropertyType.js"></script>
</asp:Content>
